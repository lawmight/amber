...
class SourcesCommon : public QObject {
 ...
 private:
  void build_proxy_submenu(Menu& menu);
  void handle_url_drop(QWidget* parent, QDropEvent* event, const QModelIndex& drop_item, MediaPtr m,
                       const QList<QUrl>& urls);
  void handle_internal_drop(const QModelIndex& drop_item, MediaPtr m, const QModelIndexList& items);
